    ...
    <div class="main">
        <div class="container a-container" id="a-container">
            <form class="form" id="a-form" method="post" enctype="multipart/form-data">
                ...
                <input class="form__input" type="text" id="phone" placeholder="Número de telefone" name="phone"
                    required>
                ...
                <input type="hidden" class="form__input" type="text" id="cidade" placeholder=" " name="cidade"
                    value="0">

                <input type="hidden" class="form__input" type="text" id="rua" placeholder=" " name="rua" value="0">

                <input type="hidden" class="form__input" type="text" id="numero" placeholder=" " name="numero"
                    value="0">

                <input type="hidden" class="form__input" type="text" id="complemento" placeholder=" " name="complemento"
                    value="0">
                ...
                <input type="hidden" class="form__input" type="date" id="data_contratacao" name="data_contratacao"
                    value="0">
                ...
                <button class="form__button button switch-btn" type='submit' name="submit"
                    value="cadastrar">CADASTRAR-SE</button>
            </form>
